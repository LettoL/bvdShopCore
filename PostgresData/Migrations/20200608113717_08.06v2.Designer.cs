...
namespace PostgresData.Migrations
{
    ...
    [Migration("20200608113717_08.06v2")]
    partial class _0806v2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.RepaidDebtOld", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Domain.Entities.SaleFromStockOld", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Domain.Entities.SoldProductFromStockOld", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Domain.Entities.SoldProductFromStockOld", b =>
                {
                    b.HasOne("Domain.Entities.SaleFromStockOld", "SaleFromStockOld")
                        .WithMany("Products")
